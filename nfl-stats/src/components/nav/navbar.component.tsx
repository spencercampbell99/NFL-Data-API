            ...
            <ul className="flex justify-center space-x-4 py-6">
                ...
                <NavListItem>
                    <NavbarDropdown title={dropdowns.games.title} isActive={dropdowns.games.active} toggleActive={() => toggleActiveDropdown('games')}>
                        <NavbarLink href="/nfl/games/2026/1" className={user ? 'border-b-[1px] border-nflWhite' : ''}>
                            Weekly Games
                    </NavbarLink>
                        <NavbarLink href="/nfl/games/2026/1/sportsbook-performance" className={"border-b-[1px] border-nflWhite"} navRequirements={requireBasicAccessObject}>
                            Weekly Sportsbook Performance
                        </NavbarLink>
                        <NavbarLink href="/nfl/games/2026/1/model-performance" navRequirements={requireBasicAccessObject}>

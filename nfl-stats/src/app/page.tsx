...
export default function Home() {
  ...
  return (
    <main>
      ...
      {/* <button onClick={() => loadBoxScoresForYears(2023, 2023)}>Load boxscores</button> */}
      <button onClick={() => loadPlayerStatsForYears(2023, 2023)}>Load player stats</button>
    </main>
  )
}

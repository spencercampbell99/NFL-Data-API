            ...
            query.include = [
                {
                    ...
                    attributes: ['home_team_score', 'away_team_score', 'total_score', 'over_under', 'cover_spread', 'home_win', 'underdog_win', 'suggested_moneyline_percent_bet', 'correct_winner', 'correct_winner_by_score'],
                }
            ]

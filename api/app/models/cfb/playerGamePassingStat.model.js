...
module.exports = (sequelize, Sequelize) => {
  ...
  PlayerGamePassingStat.init({
    ...
    completions: {type: DataTypes.INTEGER, allowNull: true},
    yards: {type: DataTypes.INTEGER, allowNull: true},
    touchdowns: {type: DataTypes.INTEGER, allowNull: true},
    interceptions: {type: DataTypes.INTEGER, allowNull: true},
    average_per_attempt: {type: DataTypes.DECIMAL(4, 2), allowNull: true},
    average_per_completion: {type: DataTypes.DECIMAL(4, 2), allowNull: true},
    epa: {type: DataTypes.DECIMAL(4, 2), allowNull: true},
    qbr: {type: DataTypes.DECIMAL(4, 2), allowNull: true}
  }, {
    sequelize,

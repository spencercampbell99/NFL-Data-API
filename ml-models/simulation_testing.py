        ...
        f"""
            WITH RankedGames AS (
                SELECT
                    ...
                    team.punts_inside_20 AS team_punts_inside_20,
                    team.field_goals_attempted AS team_field_goals_attempted,
                    team.defense_forced_fumbles AS team_defense_forced_fumbles,
                    team.defense_passes_defended AS team_defense_passes_defended,
                    team.defense_sacks AS team_defense_sacks,
                    team.penalty_yards_against AS team_penalty_yards_against,
            ...
            SELECT
                ...
                AVG(team_punts_inside_20) AS punts_inside_20,
                AVG(team_field_goals_attempted) AS field_goals_attempted,
                AVG(team_defense_forced_fumbles) AS defense_forced_fumbles,
                AVG(team_defense_passes_defended) AS defense_passes_defended,
                AVG(team_defense_sacks) AS defense_sacks,
                AVG(team_penalty_yards_against) AS penalty_yards_against,
        ...
        f"""
            WITH RankedGames AS (
                SELECT
                    ...
                    opp.punts_inside_20 AS opp_punts_inside_20,
                    opp.field_goals_attempted AS opp_field_goals_attempted,
                    opp.defense_forced_fumbles AS opp_defense_forced_fumbles,
                    opp.defense_passes_defended AS opp_defense_passes_defended,
                    opp.defense_sacks AS opp_defense_sacks,
                    opp.penalty_yards_against AS opp_penalty_yards_against,
                    team.rushing_attempts AS team_rushing_attempts,
            ...
            SELECT 
                ...
                AVG(opp_punts_inside_20) AS punts_inside_20,
                AVG(opp_field_goals_attempted) AS field_goals_attempted,
                AVG(opp_defense_forced_fumbles) AS defense_forced_fumbles,
                AVG(opp_defense_passes_defended) AS defense_passes_defended,
                AVG(opp_defense_sacks) AS defense_sacks,
                AVG(opp_penalty_yards_against) AS penalty_yards_against,
